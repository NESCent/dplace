angular.module('dplace', ['ngRoute', 'dplaceServices', 'ui.bootstrap', 'dplaceFilters', 'dplaceMapDirective', 'languagePhylogenyDirective', 'heightAttributeDirective']) // Should look at ui-router
    .config(dplaceRouter);
