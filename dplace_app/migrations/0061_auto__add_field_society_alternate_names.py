...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Society.alternate_names'
        db.add_column(u'dplace_app_society', 'alternate_names',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Society.alternate_names'
        db.delete_column(u'dplace_app_society', 'alternate_names')
