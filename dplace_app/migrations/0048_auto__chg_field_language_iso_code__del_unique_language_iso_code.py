...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Language', fields ['iso_code']
        db.delete_unique(u'dplace_app_language', ['iso_code_id'])


        # Changing field 'Language.iso_code'
        db.alter_column(u'dplace_app_language', 'iso_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.ISOCode'], null=True))

    def backwards(self, orm):

        # Changing field 'Language.iso_code'
        db.alter_column(u'dplace_app_language', 'iso_code_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', unique=True, to=orm['dplace_app.ISOCode']))
        # Adding unique constraint on 'Language', fields ['iso_code']
        db.create_unique(u'dplace_app_language', ['iso_code_id'])
    ...
    models = {
        ...
        u'dplace_app.language': {
            ...
            'glotto_code': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dplace_app.GlottoCode']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
