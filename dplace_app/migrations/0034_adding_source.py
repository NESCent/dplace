...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnvironmentalValue.source'
        db.add_column(u'dplace_app_environmentalvalue', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.Source'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnvironmentalValue.source'
        db.delete_column(u'dplace_app_environmentalvalue', 'source_id')
