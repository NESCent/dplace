...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LanguageTree.newick_string'
        db.add_column(u'dplace_app_languagetree', 'newick_string',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LanguageTree.newick_string'
        db.delete_column(u'dplace_app_languagetree', 'newick_string')
