...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LanguageClass', fields ['name']
        db.delete_unique(u'dplace_app_languageclass', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'LanguageClass', fields ['name']
        db.create_unique(u'dplace_app_languageclass', ['name'])
