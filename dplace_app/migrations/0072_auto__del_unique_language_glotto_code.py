...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Language', fields ['glotto_code']
        db.delete_unique(u'dplace_app_language', ['glotto_code_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Language', fields ['glotto_code']
        db.create_unique(u'dplace_app_language', ['glotto_code_id'])
