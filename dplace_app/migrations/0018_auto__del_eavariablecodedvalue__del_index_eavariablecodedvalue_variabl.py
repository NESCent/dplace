...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename model 'EAVariableCodedValue' to 'VariableCodedValue'
        db.rename_table(u'dplace_app_eavariablecodedvalue',u'dplace_app_variablecodedvalue')

    def backwards(self, orm):
        # Rename model 'EAVariableCodedValue' to 'VariableCodedValue'
        db.rename_table(u'dplace_app_variablecodedvalue',u'dplace_app_eavariablecodedvalue')
