...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LanguageClass.language_count'
        db.add_column(u'dplace_app_languageclass', 'language_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LanguageClass.language_count'
        db.delete_column(u'dplace_app_languageclass', 'language_count')
