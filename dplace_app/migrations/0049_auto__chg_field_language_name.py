...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dplace_app_language', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Language.name'
        db.alter_column(u'dplace_app_language', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
