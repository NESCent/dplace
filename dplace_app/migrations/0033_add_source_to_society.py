...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing index on 'Society', fields ['source']
        db.delete_index(u'dplace_app_society', ['source_id'])


        # User chose to not deal with backwards NULL issues for 'Society.source'
        raise RuntimeError("Cannot reverse this migration. 'Society.source' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Renaming column for 'Society.source' to match new field type.
        db.rename_column(u'dplace_app_society', 'source_id', 'source')
        # Changing field 'Society.source'
        db.alter_column(u'dplace_app_society', 'source', self.gf('django.db.models.fields.CharField')(max_length=16))
