...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dplace_app_source', 'year', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Source.year'
        db.alter_column(u'dplace_app_source', 'year', self.gf('django.db.models.fields.CharField')(max_length=10))
