...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnvironmentalVariable.codebook_info'
        db.add_column(u'dplace_app_environmentalvariable', 'codebook_info',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnvironmentalVariable.codebook_info'
        db.delete_column(u'dplace_app_environmentalvariable', 'codebook_info')
