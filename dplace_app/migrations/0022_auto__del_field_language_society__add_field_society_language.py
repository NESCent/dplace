...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Society.language'
        db.add_column(u'dplace_app_society', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='societies', null=True, to=orm['dplace_app.Language']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Society.language'
        db.delete_column(u'dplace_app_society', 'language_id')
