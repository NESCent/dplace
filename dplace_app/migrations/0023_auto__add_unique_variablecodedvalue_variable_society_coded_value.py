...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VariableCodedValue', fields ['variable', 'society', 'coded_value']
        db.create_unique(u'dplace_app_variablecodedvalue', ['variable_id', 'society_id', 'coded_value'])


    def backwards(self, orm):
        # Removing unique constraint on 'VariableCodedValue', fields ['variable', 'society', 'coded_value']
        db.delete_unique(u'dplace_app_variablecodedvalue', ['variable_id', 'society_id', 'coded_value'])
