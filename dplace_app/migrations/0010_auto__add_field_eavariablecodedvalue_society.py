...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EAVariableCodedValue.society'
        db.add_column(u'dplace_app_eavariablecodedvalue', 'society',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.Society'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'EAVariableCodedValue.society'
        db.delete_column(u'dplace_app_eavariablecodedvalue', 'society_id')
