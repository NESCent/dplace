...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LanguageTree'
        db.create_table(u'dplace_app_languagetree', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
        ))
        db.send_create_signal(u'dplace_app', ['LanguageTree'])

        # Adding M2M table for field languages on 'LanguageTree'
        m2m_table_name = db.shorten_name(u'dplace_app_languagetree_languages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('languagetree', models.ForeignKey(orm[u'dplace_app.languagetree'], null=False)),
            ('language', models.ForeignKey(orm[u'dplace_app.language'], null=False))
        ))
        db.create_unique(m2m_table_name, ['languagetree_id', 'language_id'])


    def backwards(self, orm):
        # Deleting model 'LanguageTree'
        db.delete_table(u'dplace_app_languagetree')

        # Removing M2M table for field languages on 'LanguageTree'
        db.delete_table(db.shorten_name(u'dplace_app_languagetree_languages'))
