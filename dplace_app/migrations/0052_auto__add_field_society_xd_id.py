...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Society.xd_id'
        db.add_column(u'dplace_app_society', 'xd_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Society.xd_id'
        db.delete_column(u'dplace_app_society', 'xd_id')
