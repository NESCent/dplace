...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Society.glotto_code'
        db.add_column(u'dplace_app_society', 'glotto_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='societies', null=True, to=orm['dplace_app.GlottoCode']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Society.glotto_code'
        db.delete_column(u'dplace_app_society', 'glotto_code_id')
