...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Environmental.source'
        db.add_column(u'dplace_app_environmental', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.Source'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Environmental.source'
        db.delete_column(u'dplace_app_environmental', 'source_id')
