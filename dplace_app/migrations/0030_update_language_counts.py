...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for language_class in orm.LanguageClass.objects.all():
            if language_class.level == 1:
                language_class.language_count = language_class.languages1.count()
            elif language_class.level == 2:
                language_class.language_count = language_class.languages2.count()
            elif language_class.level == 3:
                language_class.language_count = language_class.languages3.count()
            language_class.save()
