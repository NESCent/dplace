...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnvironmentalVariable.description'
        db.add_column(u'dplace_app_environmentalvariable', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnvironmentalVariable.description'
        db.delete_column(u'dplace_app_environmentalvariable', 'description')
