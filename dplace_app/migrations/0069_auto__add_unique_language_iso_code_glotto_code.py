...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Language', fields ['iso_code', 'glotto_code']
        db.create_unique(u'dplace_app_language', ['iso_code_id', 'glotto_code_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Language', fields ['iso_code', 'glotto_code']
        db.delete_unique(u'dplace_app_language', ['iso_code_id', 'glotto_code_id'])
