...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariableCodedValue.subcase'
        db.add_column(u'dplace_app_variablecodedvalue', 'subcase',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VariableCodedValue.subcase'
        db.delete_column(u'dplace_app_variablecodedvalue', 'subcase')
