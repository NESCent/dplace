...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariableCodedValue.focal_year'
        db.add_column(u'dplace_app_variablecodedvalue', 'focal_year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VariableCodedValue.focal_year'
        db.delete_column(u'dplace_app_variablecodedvalue', 'focal_year')
