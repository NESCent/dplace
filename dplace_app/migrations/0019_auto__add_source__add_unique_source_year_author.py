...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Source'
        db.create_table(u'dplace_app_source', (
            ...
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('focal_year', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('subcase', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
        ))
        db.send_create_signal(u'dplace_app', ['Source'])

        # Adding unique constraint on 'Source', fields ['year', 'author']
        db.create_unique(u'dplace_app_source', ['year', 'author'])


    def backwards(self, orm):
        # Removing unique constraint on 'Source', fields ['year', 'author']
        db.delete_unique(u'dplace_app_source', ['year', 'author'])

        # Deleting model 'Source'
        db.delete_table(u'dplace_app_source')
