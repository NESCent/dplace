...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field society_links on 'Society'
        m2m_table_name = db.shorten_name(u'dplace_app_society_society_links')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_society', models.ForeignKey(orm[u'dplace_app.society'], null=False)),
            ('to_society', models.ForeignKey(orm[u'dplace_app.society'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_society_id', 'to_society_id'])


    def backwards(self, orm):
        # Removing M2M table for field society_links on 'Society'
        db.delete_table(db.shorten_name(u'dplace_app_society_society_links'))
    ...
    models = {
        ...
        u'dplace_app.society': {
            ...
            'society_links': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['dplace_app.Society']", 'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dplace_app.Source']", 'null': 'True'})
        },
        u'dplace_app.source': {
