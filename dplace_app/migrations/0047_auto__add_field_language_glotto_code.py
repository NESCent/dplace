...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Language.glotto_code'
        db.add_column(u'dplace_app_language', 'glotto_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.GlottoCode'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Language.glotto_code'
        db.delete_column(u'dplace_app_language', 'glotto_code_id')
    ...
    models = {
        ...
        u'dplace_app.language': {
            ...
            'glotto_code': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dplace_app.GlottoCode']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
