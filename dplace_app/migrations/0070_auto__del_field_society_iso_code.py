...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Society.iso_code'
        db.delete_column(u'dplace_app_society', 'iso_code_id')


    def backwards(self, orm):
        # Adding field 'Society.iso_code'
        db.add_column(u'dplace_app_society', 'iso_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='societies', null=True, to=orm['dplace_app.ISOCode']),
                      keep_default=False)
