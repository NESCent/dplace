...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VariableCategory', fields ['name']
        db.create_unique(u'dplace_app_variablecategory', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'VariableCategory', fields ['name']
        db.delete_unique(u'dplace_app_variablecategory', ['name'])
