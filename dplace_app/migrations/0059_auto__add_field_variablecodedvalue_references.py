...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field references on 'VariableCodedValue'
        m2m_table_name = db.shorten_name(u'dplace_app_variablecodedvalue_references')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('variablecodedvalue', models.ForeignKey(orm[u'dplace_app.variablecodedvalue'], null=False)),
            ('source', models.ForeignKey(orm[u'dplace_app.source'], null=False))
        ))
        db.create_unique(m2m_table_name, ['variablecodedvalue_id', 'source_id'])


    def backwards(self, orm):
        # Removing M2M table for field references on 'VariableCodedValue'
        db.delete_table(db.shorten_name(u'dplace_app_variablecodedvalue_references'))
    ...
    models = {
        ...
        u'dplace_app.variablecodedvalue': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'references': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'references'", 'symmetrical': 'False', 'to': u"orm['dplace_app.Source']"}),
