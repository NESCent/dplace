...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GlottoCode'
        db.create_table(u'dplace_app_glottocode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('glotto_code', self.gf('django.db.models.fields.CharField')(max_length=10, db_index=True)),
        ))
        db.send_create_signal(u'dplace_app', ['GlottoCode'])


    def backwards(self, orm):
        # Deleting model 'GlottoCode'
        db.delete_table(u'dplace_app_glottocode')
