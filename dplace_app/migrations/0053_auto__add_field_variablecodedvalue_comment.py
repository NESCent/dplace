...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariableCodedValue.comment'
        db.add_column(u'dplace_app_variablecodedvalue', 'comment',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VariableCodedValue.comment'
        db.delete_column(u'dplace_app_variablecodedvalue', 'comment')
