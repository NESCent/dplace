...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LanguageTree.source'
        db.add_column(u'dplace_app_languagetree', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.Source'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LanguageTree.source'
        db.delete_column(u'dplace_app_languagetree', 'source_id')
