...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VariableDescription.label'
        db.alter_column(u'dplace_app_variabledescription', 'label', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'VariableDescription.label'
        db.alter_column(u'dplace_app_variabledescription', 'label', self.gf('django.db.models.fields.CharField')(max_length=10))
