...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LanguageTree.file'
        db.add_column(u'dplace_app_languagetree', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LanguageTree.file'
        db.delete_column(u'dplace_app_languagetree', 'file')
