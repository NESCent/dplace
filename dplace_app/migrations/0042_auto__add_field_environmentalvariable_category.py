...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnvironmentalVariable.category'
        db.add_column(u'dplace_app_environmentalvariable', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.EnvironmentalCategory'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnvironmentalVariable.category'
        db.delete_column(u'dplace_app_environmentalvariable', 'category_id')
