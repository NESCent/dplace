...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'EAVariableDescription' to 'VariableDescription'
        db.rename_table(u'dplace_app_eavariabledescription',u'dplace_app_variabledescription')

        # Changing field 'EAVariableCodedValue.variable'
        db.alter_column(u'dplace_app_eavariablecodedvalue', 'variable_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.VariableDescription']))

        # Changing field 'EAVariableCodeDescription.variable'
        db.alter_column(u'dplace_app_eavariablecodedescription', 'variable_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.VariableDescription']))

    def backwards(self, orm):
        # Rename 'VariableDescription' to 'EAVariableDescription'
        db.rename_table(u'dplace_app_variabledescription',u'dplace_app_eavariabledescription')

        # Changing field 'EAVariableCodedValue.variable'
        db.alter_column(u'dplace_app_eavariablecodedvalue', 'variable_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.EAVariableDescription']))

        # Changing field 'EAVariableCodeDescription.variable'
        db.alter_column(u'dplace_app_eavariablecodedescription', 'variable_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dplace_app.EAVariableDescription']))
