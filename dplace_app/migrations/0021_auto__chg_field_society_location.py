...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Society.location'
        db.alter_column(u'dplace_app_society', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))

    def backwards(self, orm):

        # Changing field 'Society.location'
        db.alter_column(u'dplace_app_society', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(default=Point(0, 0)))
