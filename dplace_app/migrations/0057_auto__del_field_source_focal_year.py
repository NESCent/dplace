...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Source.focal_year'
        db.delete_column(u'dplace_app_source', 'focal_year')


    def backwards(self, orm):
        # Adding field 'Source.focal_year'
        db.add_column(u'dplace_app_source', 'focal_year',
