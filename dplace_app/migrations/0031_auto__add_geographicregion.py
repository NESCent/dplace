...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dplace_app_geographicregion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('level_2_re', self.gf('django.db.models.fields.FloatField')()),
            ('count', self.gf('django.db.models.fields.FloatField')()),
            ('region_nam', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('continent', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('tdwg_code', self.gf('django.db.models.fields.IntegerField')()),
            ('geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')()),
        ))
        db.send_create_signal(u'dplace_app', ['GeographicRegion'])


    def backwards(self, orm):
        # Deleting model 'GeographicRegion'
        db.delete_table(u'dplace_app_geographicregion')
