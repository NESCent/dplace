...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'EAVariableCodedValue', fields ['variable', 'society']
        db.create_index(u'dplace_app_eavariablecodedvalue', ['variable_id', 'society_id'])

        # Adding index on 'EAVariableCodedValue', fields ['variable', 'code']
        db.create_index(u'dplace_app_eavariablecodedvalue', ['variable_id', 'code_id'])

        # Adding index on 'EAVariableCodedValue', fields ['society', 'code']
        db.create_index(u'dplace_app_eavariablecodedvalue', ['society_id', 'code_id'])

        # Adding index on 'EAVariableCodedValue', fields ['society', 'coded_value']
        db.create_index(u'dplace_app_eavariablecodedvalue', ['society_id', 'coded_value'])

        # Adding index on 'EAVariableCodedValue', fields ['variable', 'coded_value']
        db.create_index(u'dplace_app_eavariablecodedvalue', ['variable_id', 'coded_value'])


    def backwards(self, orm):
        # Removing index on 'EAVariableCodedValue', fields ['variable', 'coded_value']
        db.delete_index(u'dplace_app_eavariablecodedvalue', ['variable_id', 'coded_value'])

        # Removing index on 'EAVariableCodedValue', fields ['society', 'coded_value']
        db.delete_index(u'dplace_app_eavariablecodedvalue', ['society_id', 'coded_value'])

        # Removing index on 'EAVariableCodedValue', fields ['society', 'code']
        db.delete_index(u'dplace_app_eavariablecodedvalue', ['society_id', 'code_id'])

        # Removing index on 'EAVariableCodedValue', fields ['variable', 'code']
        db.delete_index(u'dplace_app_eavariablecodedvalue', ['variable_id', 'code_id'])

        # Removing index on 'EAVariableCodedValue', fields ['variable', 'society']
        db.delete_index(u'dplace_app_eavariablecodedvalue', ['variable_id', 'society_id'])
