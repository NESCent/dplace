...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LanguageClass.parent'
        db.add_column(u'dplace_app_languageclass', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dplace_app.LanguageClass'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LanguageClass.parent'
        db.delete_column(u'dplace_app_languageclass', 'parent_id')
