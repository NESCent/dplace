...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LanguageFamily.language_count'
        db.add_column(u'dplace_app_languagefamily', 'language_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LanguageFamily.language_count'
        db.delete_column(u'dplace_app_languagefamily', 'language_count')
