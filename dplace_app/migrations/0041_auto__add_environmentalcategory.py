...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnvironmentalCategory'
        db.create_table(u'dplace_app_environmentalcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, db_index=True)),
        ))
        db.send_create_signal(u'dplace_app', ['EnvironmentalCategory'])


    def backwards(self, orm):
        # Deleting model 'EnvironmentalCategory'
        db.delete_table(u'dplace_app_environmentalcategory')
