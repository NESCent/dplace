...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VariableCodedValue.coded_value'
        db.alter_column(u'dplace_app_variablecodedvalue', 'coded_value', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'VariableCodedValue.coded_value'
        db.alter_column(u'dplace_app_variablecodedvalue', 'coded_value', self.gf('django.db.models.fields.CharField')(max_length=20))
