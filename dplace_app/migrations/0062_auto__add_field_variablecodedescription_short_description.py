...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariableCodeDescription.short_description'
        db.add_column(u'dplace_app_variablecodedescription', 'short_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VariableCodeDescription.short_description'
        db.delete_column(u'dplace_app_variablecodedescription', 'short_description')
