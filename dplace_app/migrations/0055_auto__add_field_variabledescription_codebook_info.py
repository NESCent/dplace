...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariableDescription.codebook_info'
        db.add_column(u'dplace_app_variabledescription', 'codebook_info',
                      self.gf('django.db.models.fields.TextField')(default='None'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VariableDescription.codebook_info'
        db.delete_column(u'dplace_app_variabledescription', 'codebook_info')
